...
layout(location = 3) in mat3 uModelToNDC; // Instanced model-to-NDC matrix
...
void main() {
    ...
    // Apply the instance-specific transformation
    gl_Position = vec4((uModelToNDC * vec3(vPosition, 1.0)).xy, 0.0, 1.0);
}

// Old without instanced rendering
