...
IMGD
BIN ZAKARIA Muhammad Zikry        ( Programmer | Audio Lead | Level Editor Champion )
CHUA Sheng Kai Jovan                ( Programmer | Designer | Gameplay/AI Champion )
TAN Yan Kai                        ( Programmer | Designer | Serialization Champion )


UXGD
LEE Ying Jie                        ( Design Lead | Designer | Level Design/Mechanic Champion)
CHUA Qi Yun Daphnne                ( Product Manager | Art Lead | Art/Story Champion)




Game Concept:
You play as a duck, who in a turn of events, ends up as the stand-in manager for your parent’s store while they go on a trip. As an amateur manager, one who has never done this before, your goal is to do your best in managing the store.
...
3. Gameplay:
* Prepare food ingredients by chopping, boiling or frying them
* Assemble the required ingredients on a plate and when ready, submit the plate to a serving station to gain points


Features:
1. Ingredients pickup/put down


* Able to pick up and put down ingredients


2. Chopping 


* Put ingredient on chopping board and hold K to start cutting
* Chopping is completed once the ingredient undergoes a visible change in appearance/ progress bar is full
* How to use: Put an ingredient on the chopping board and hold K to chop
...
* Meat can be overcooked (burnt) if player does not take the cooked meat out of the pan within a certain period of time
* Indicated by a visible change in appearance
...
* Customers will walk in and stop in front of the cashier and player has to press J to interact with them to take the order
