...
Operating-system components are governed by the licenses supplied with the
operating system or Flatpak runtime.

## Fonts and assets

- `Fonts.txt` — Kenney fonts (CC0) and Inter (SIL Open Font License 1.1).
